...
#ifort $GMXXTC/xtc-interface-wrap.o $OPENMMDCD/dcdmod.o $OPENMMDCD/trajmod.o variables.f90 topol.f90 fvector.f90 filehandle.f90 velanal.f90 -o vel_anal_omp -lxdrfile -L $GMXXTC/lib -I $GMXXTC -I $OPENMMDCD

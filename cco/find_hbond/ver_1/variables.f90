...
MODULE variables
  ...
  integer :: nneigh, nAtCavity, nGLU, nPRD, nBNC, nRef
  ...
  real*8             :: dCut, dHbond, angHbond
  real*8,dimension(3) :: xgluc, xprdc          ! position of center of glu oxigens and prd oxigens
